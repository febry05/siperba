...
<div id="tengah">
    <div class="col">
        ...
        if (isset($_POST['simpan_button'])) {
            ...
            $checkSQL = "SELECT * FROM pegawai WHERE nama_pegawai = '$nama_pegawai'";
        ...
        ?>
                ...
                $insertSQL = "INSERT INTO pegawai SET nama_pegawai='$nama_pegawai', 
                nip='$nip',
                id_divisi='$id_divisi'";
            ...
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="id_divisi" required>
                        ...
                        ?>
                            <option value="<?= $rowDivisi['id_divisi'] ?>"><?= $rowDivisi["nama_divisi"] ?></option>
                        <?php
                        }
                        ?>
                    </select>
